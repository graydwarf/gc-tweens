...
func MoveDirection1():
	_tween1.interpolate_property(_easeInIcon, "position", Vector2(64, 64),
		Vector2(500, 64), _tweenSpeed,
		_tweenTransistionType, Tween.EASE_IN, _tweenWaitTime)
	_tween1.start()

	_tween2.interpolate_property(_easeOutIcon, "position", Vector2(64, 128),
		Vector2(500, 128), _tweenSpeed,
		_tweenTransistionType, Tween.EASE_OUT, _tweenWaitTime)
	_tween2.start()

	_tween3.interpolate_property(_easeOutInIcon, "position", Vector2(64, 192),
		Vector2(500, 192), _tweenSpeed,
		_tweenTransistionType, Tween.EASE_IN_OUT, _tweenWaitTime)
	_tween3.start()

	_tween4.interpolate_property(_easeInOutIcon, "position", Vector2(64, 256),
		Vector2(500, 256), _tweenSpeed,
		_tweenTransistionType, Tween.EASE_OUT_IN, _tweenWaitTime)
	_tween4.start()

func MoveDirection2():
	_tween1.interpolate_property(_easeInIcon, "position", Vector2(500, 64),
		Vector2(64, 64), _tweenSpeed,
		_tweenTransistionType, Tween.EASE_IN, _tweenWaitTime)
	_tween1.start()

	_tween2.interpolate_property(_easeOutIcon, "position", Vector2(500, 128),
		Vector2(64, 128), _tweenSpeed,
		_tweenTransistionType, Tween.EASE_OUT, _tweenWaitTime)
	_tween2.start()

	_tween3.interpolate_property(_easeInOutIcon, "position", Vector2(500, 192),
		Vector2(64, 192), _tweenSpeed,
		_tweenTransistionType, Tween.EASE_IN_OUT, _tweenWaitTime)
	_tween3.start()

	_tween4.interpolate_property(_easeOutInIcon, "position", Vector2(500, 256),
		Vector2(64, 256), _tweenSpeed,
		_tweenTransistionType, Tween.EASE_OUT_IN, _tweenWaitTime)
	_tween4.start()
